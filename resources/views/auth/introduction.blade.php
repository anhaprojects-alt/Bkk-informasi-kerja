...
<body class="bg-slate-50 font-sans antialiased text-slate-800">
    <div class="max-w-md mx-auto min-h-screen bg-white flex flex-col justify-between p-6 shadow-xl relative overflow-hidden">
        ...
        <div class="absolute -top-24 -right-24 w-48 h-48 bg-indigo-500 rounded-full opacity-10"></div>
        <div class="absolute -top-12 -left-12 w-32 h-32 bg-sky-500 rounded-full opacity-10"></div>
        ...
        <div class="my-auto text-center px-4 z-10">
            <div class="w-64 h-64 mx-auto mb-8 bg-indigo-50 rounded-full flex items-center justify-center relative">
                <!-- Inner animation/design placeholder -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-40 w-40 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
