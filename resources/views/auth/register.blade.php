...
<body class="bg-gradient-to-br from-slate-100 to-slate-200 font-sans antialiased text-slate-800">
    <div class="auth-shell">
        <div class="auth-container min-h-screen md:min-h-[auto] flex flex-col justify-between p-6 relative">
            ...
            <form method="POST" action="{{ route('register.post') }}" class="my-6 space-y-4 bg-white p-5 rounded-3xl border border-slate-200/60 shadow-[0_10px_30px_rgba(0,0,0,0.04)]"
